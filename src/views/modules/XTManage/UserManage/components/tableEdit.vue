<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="真实姓名" prop="author">
        <el-input v-model.trim="form.author" autocomplete="off" clearable />
      </el-form-item>
      ...
      <el-form-item label="联系电话" prop="author" clearable>
        <el-input v-model.trim="form.author" autocomplete="off" />
      </el-form-item>
      <el-form-item label="登录密码" prop="author" clearable>
        <el-input v-model.trim="form.author" autocomplete="off" />
      </el-form-item>
    </el-form>
